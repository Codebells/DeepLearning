        ...
        <div class="row">
            <div class="col-12">
                <nav class="navbar navbar-expand-xl navbar-light bg-light">
                        <h1 class="tm-site-title mb-0">Student_Manage</h1>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link d-flex" href="student_manager.php">
                                    <span>返回</span>
                                </a>
                            </li>
                        </ul>
                ...
                <div class="bg-white tm-block">
                    <div class="row mt-4 tm-edit-product-row">
                        <div class="col-xl-7 col-lg-7 col-md-12" style="margin:0 auto">
                            <form action="add_student_chuli.php"  method="POST">
                                <div class="input-group mb-3">
                                    <label for="sno" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Student
                                        Sno
                                    </label>
                                    <input id="sno" name="sno" type="text" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7">
                                </div>
                                <div class="input-group mb-3">
                                    <label for="name" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Student name
                                    </label>
                                    <input id="name" name="name" type="text" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7">
                                </div>
                                <div class="input-group mb-3">
                                    <label for="cno" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Card no
                                    </label>
                                    <input id="cno" name="cno" type="text" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7">
                                </div>
                                <div class="input-group mb-3">
