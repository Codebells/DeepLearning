        ...
        <div class="row">
            <div class="col-12">
                <nav class="navbar navbar-expand-xl navbar-light bg-light">
                    <h1 class="tm-site-title mb-0">StudentBoard</h1>
        ...
        <div class="row tm-content-row tm-mt-big">
            <div class="tm-col tm-col-big">
                <div class="bg-white tm-block">
                    ...
                    <ol class="tm-list-group tm-list-group-alternate-color tm-list-group-pad-big">
                        ...
                        $word = "select sno,sname from west_sys.student";
                        ...
                        while ($row = oci_fetch_array($stat)) {
                            ...
                            <?php
                            $nowsno=$row["SNO"];
                            $wordd="select signplace,signdate from west_signin where $nowsno=sno";
                            $sta=oci_parse($conn,$wordd);
                            oci_execute($sta,OCI_COMMIT_ON_SUCCESS);
                            while($row2=oci_fetch_array($sta))
                            {
                            ?>
                            <li class="tm-list-group-item">
                                <?php
                                    echo $row["SNO"] . " " . $row["SNAME"]." ".$row2["SIGNPLACE"]." ".substr_replace($row2["SIGNDATE"],"月",5,2);
                                    ?>
                            </li>
                        <?php
                            }
            ...
            <div class="tm-col tm-col-big">
                <div class="bg-white tm-block">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form action="Teacher_chuli.php" class="tm-signup-form" method="POST">
                                ...
                                <div class="form-group">
                                    <label for="password">SignPlace</label>
                                    <input placeholder="CenterBuilding" id="password" name="place" type="text" class="form-control validate">
                                </div>
                                <div class="form-group">
                                    <label for="date">SignDate</label>
                                    <input placeholder="2019/11/17" id="date" name="date" type="text" class="form-control validate">
                                </div>
                                
                                <div class="row">
                                    <div class="col-12 col-sm-8 tm-btn-right">
                                        <button type="submit"name="click" value="delete"  class="btn btn-danger">Delete data
                                        </button>
                                    </div>
                                </div>
